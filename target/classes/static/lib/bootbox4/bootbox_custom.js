...
window.bootbox = window.bootbox || (function init($, undefined) {
  ...
  var templates = {
    dialog:
      "<div id='myModal' class='bootbox modal myDialog' tabindex='-1' role='dialog'>" +
        "<div class='modal-dialog'>" +
        "<div class='modal-body pad'>" +
        " <div class='gbheader'>" +
        "<button class='bootbox-close-button close' type='button' style='margin:5px 15px 0 0'>&times;</button>"+
    	"</div>" +
        "<div class='modal-content'>" +
            "<br><div class='alert alert-warning'> <strong>注意!</strong><div class='bootbox-body'></div></div></div>" +
          "</div>" +
        "</div>" +
      "</div>",
    header:
  ...
  exports.dialog = function(options) {
   ...
   /* if (options.closeButton) {
      ...
      if (options.title) {
        ...
        closeButton.css("margin-top", "5px").prependTo(body);
        closeButton.css("margin-right","15px").prependTo(body);
      }
    }*/
