	...
	<div class="container">
		...
		<div class="row footer-bottom d-flex justify-content-between">
			...
			<div class="col-lg-4 col-sm-12">
				<a href="##" onclick="toSinawebo()" title="分享到微博"><img src="${rc.contextPath}/lib/blog/img/wb.png" class="rounded img-thumbnail" style="width:40px;height:40px;float:right;margin-left:10px;background-color:#fff"></a>
				<a href="##" onclick="toQQSpace()" title="分享到QQ空间"><img src="${rc.contextPath}/lib/blog/img/qq.png" class="rounded img-thumbnail" style="width:40px;height:40px;float:right;margin-left:10px;background-color:#fff;"></a>
				<a href="##" onclick="toQQ()" title="分享到QQ"><img src="${rc.contextPath}/lib/blog/img/qqlogo.png" class="rounded img-thumbnail" style="width:40px;height:40px;float:right;margin-left:10px;background-color:#fff;"></a>
				<a href="##" onclick="toWX()" title="分享到微信"><img src="${rc.contextPath}/lib/blog/img/wx.png" class="rounded img-thumbnail" style="width:40px;height:40px;float:right;margin-left:10px;background-color:#fff;"></a>
			</div>
		</div>
	</div>
</footer>
